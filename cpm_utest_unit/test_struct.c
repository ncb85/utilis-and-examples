...
testStructAEq() {
    printf("Testing global struct_a equals");
    if (struct_a.a == 5000) {
        writeOK();
    } else {
        writeNOK();
...
testStructBEq() {
    printf("Testing global struct_b equals");
    if (struct_b.a == 34567) {
        writeOK();
    } else {
        writeNOK();
...
testStructAssign() {
    printf("Testing global struct_a assign");
    ...
    printf("Testing global struct_b assign");
    struct_a.c = -4567;
...
testUnionAssign() {
    printf("Testing global union assign");
    union_a.a = 300;
    if (union_a.b == 44) {
        writeOK();
    } else {
...
testStructLocaleAssign() {
    ...
    printf("Testing locale struct_al assign");
...
testStructArray() {
    ...
    struct_ac[4].c = 131;
    struct_ac[4].d = 't';
    printf("Testing global struct_a array");
    if (struct_ac[0].d == 'p') {
        writeOK();
    } else {
        writeNOK();
...
testStructLocaleArray() {
    ...
    struct_bc[4].c = 131;
    struct_bc[4].d = 't';
    printf("Testing locale struct_bc array");
    if (struct_bc[0].d == 'p') {
        writeOK();
    } else {
        writeNOK();
    ...
    printf("Testing locale struct_bc array");
    if (struct_bc[4].a == 50001) {
        writeOK();
    } else {
        writeNOK();
    }
    printf("Testing locale struct_bc array");
    if (struct_bc[01].c == 128) {
        writeOK();
    } else {
        writeNOK();
    }
    struct_bc[2].d = struct_bc[4].d;
    printf("Testing locale struct_bc array");
    if (struct_bc[2].d == 't') {
        writeOK();
    } else {
    ...
    struct_bc[4].c = struct_bc[3].c;
    printf("Testing locale struct_bc array");
    if (struct_bc[4].c == 130) {
        writeOK();
    } else {
        writeNOK();
    }
...
testStructPointer() {
    ...
    printf("Testing struct array sizeof ");
